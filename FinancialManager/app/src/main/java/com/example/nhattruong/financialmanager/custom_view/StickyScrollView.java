...
public class StickyScrollView extends NestedScrollView {
     ...
     */
    public static final String FLAG_NO_CONSTANT = "-no_constant";

    /**
     * Flag for views that have aren't fully opaque
     */
    public static final String FLAG_TRANSPARENT = "-transparent";
    ...
    public StickyScrollView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShadowHeight = a.getDimensionPixelSize(
                R.styleable.StickyScrollView_shadowHeight,
                defaultShadowHeightInPix);

        int shadowDrawableRes = a.getResourceId(
                R.styleable.StickyScrollView_shadowDrawable, -1);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (currentlyStickingView != null) {
            ...
            if (getStringTagForView(currentlyStickingView).contains(FLAG_TRANSPARENT)) {
    ...
    private void startStickingView(View viewThatShouldStick) {
        ...
        if (((String) currentlyStickingView.getTag()).contains(FLAG_NO_CONSTANT)) {
